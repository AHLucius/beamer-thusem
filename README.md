...
清华大学经济管理学院“东方蓝”视觉风格的自用 beamer 主题，欢迎有需要的同学们使用。

之前一直想用 AI 拿 beamer 做 slides，但找到的只有“清华紫”风格的 beamer 模版，据我的审美可能这个颜色不是很适合做 beamer 的主题色，反而是“经管蓝”会美观一点。因此，我把视觉形象手册喂给了 AI，在其产出中进行了少许字体和格式上的微调，形成了这个自用 beamer 模版。

经管的同学们经过实习的磨炼，大部分已经成了用 PowerPoint 做 slides 的高手，这个 beamer 模版存在的必要性可能并没有那么大。然而，如果有和我一样并不那么擅长使用 PowerPoint、或者是对 beamer 的风格有独特偏好、或者是单纯懒得动手却又觉得 AI 直接操作 PowerPoint 产出的交付物过于粗糙的同学，希望这份简单的作品能够对你们有所帮助。

只有以上内容是我写的，剩下的中文 README、全部的英文 README 和全部的代码文件都由伟大的 AI 完成。
